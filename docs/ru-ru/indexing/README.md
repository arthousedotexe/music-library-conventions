...
- Хештеги для поиска:
  ...
  - Жанры с удаленными пробелами и дефисами, подробнее [здесь](https://support.discogs.com/hc/en-us/articles/360005055213-Database-Guidelines-9-Genres-Styles);
  - Поджанры с удаленными пробелами и дефисами;  
