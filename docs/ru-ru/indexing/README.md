...
Индексный файл (```index.txt```) находится рядом с аудиофайлами. Синтаксис файла: markdown, язык файла: английский.  
...
- Поджанры альбома - при необходимости;  
...
- Треклист;  
  ...
  Если в релизе несколько дисков, то номер диска учитывается, например: ```1.02```, ```2.13```. Также пишется номер диска.  
