...
- `Album Artist Sort` - тег, который отвечает за правило сортировки исполнителя альбома, например, по фамилии или с учетом артикля;  
  Подробнее с правилами сортировки имён артистов можно ознакомиться в [документации MusicBrainz](https://musicbrainz.org/doc/Style/Artist/Sort_Name).  
